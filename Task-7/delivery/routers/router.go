...
func (r *Router) userRoutes() {
	...
	userController := controllers.NewUserController(userUseCase.(*usecase.UserUseCase))
...
func (r *Router) taskRoutes() {
	...
	taskController := controllers.NewTaskController(taskUseCase.(*usecase.TaskUseCase))
